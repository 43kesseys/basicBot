...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/43kesseys/basicBot/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/43kesseys/basicBot/master/basicBot.js",
        cmdLink: "http://git.io/x2Sw",
        ...
        commands: {
            ...
            cookieCommand: {
                ...
                cookies: ['has given you a chocolate chip cookie! :D',
                    ...
                    'gives you a fortune cookie. It reads "Give that special someone a dick in their ass."',
