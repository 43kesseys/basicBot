        ...
        commands: {
            ...
            cookieCommand: {
                ...
                cookies: ['has given you a chocolate chip cookie!',
                    'has given you aa soft homemade oatmeal cookie!',
                    'has given you a chocolate chip cookie that appears to be covered in semen.',
                    'gives you aa sugar cookie. What, no frosting and sprinkles? 0/10 would not touch.',
                    'gives you aa chocolate chip cookie. Oh wait, those are raisins. Bleck!',
                    'gives you aan enormous cookie. Poking it gives you more cookies. Weird.',
                    'gives you a fortune cookie. It reads "Do you even yiff?"',
                    'gives you aa fortune cookie. It reads "Give that special someone a compliment"',
                    'gives you a fortune cookie. It reads "Go have a wank!"',
                    'gives you aa fortune cookie. It reads "Go outside."',
                    'gives you aa fortune cookie. It reads "Don\'t forget to eat your veggies!"',
                    'gives you a fortune cookie. It reads "Ayy lmao."',
                    'gives you a fortune cookie. It reads "dolan pls"',
                    'gives you aa fortune cookie. It reads "If you move your hips, you\'ll get all the ladies."',
                    'gives you aa fortune cookie. It reads "I love you."',
                    'is all out of cookies. What a tease.',
                    'gives you aan Oreo cookie with a glass of milk!',
                    'gives you aa rainbow cookie made with love :heart:',
